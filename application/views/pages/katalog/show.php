                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="form-group <?= isInvalid('klasifikasi') ?>">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" disabled class="form-control" id="klasifikasi" name="klasifikasi" placeholder="Masukkan Tahun terbit" value="<?= set_value('klasifikasi', $item['nmr_klasifikasi'] ?: '-'); ?>">
                                            </div>
                                        </div>
