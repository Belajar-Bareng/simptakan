    ...
    <section class="content">
      <div class="row">
        <?php foreach ($items as $item) : ?>
          ...
          if ($tanggal_sekarang < $tanggal_database) {
            $status = 'Baru';
          } else {
            $status = '';
          }

          if ($item['jumlah'] == 0 && current_url('katalog')) {
            ...
            <div class="box box-widget widget-user">
              ...
              <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
                  ...
                  <?php if (uri_string() == 'katalog') : ?>
                    <li><a href="<?= $link ?>"><span class="badge bg-green"><?php echo $jumlah ?></span></a></li>
                  <?php endif; ?>
                  <li><a href="<?= $link ?>"><?= $item['tahun'] ?: '-'; ?><span class="pull-right badge"><?php echo $status ?></span></a></li>
                </ul>
              </div>
            </div>
          </div>
