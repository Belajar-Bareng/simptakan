                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group <?= isInvalid('no_inventaris') ?>">
                                <label for="no_inventaris" class="col-sm-2 control-label">No. Inventaris</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_inventaris" name="no_inventaris" placeholder="Masukkan No Inventaris" value="<?= set_value('no_inventaris'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="sumber" class="col-sm-2 control-label">Sumber</label>
                                <div class="col-sm-10">
                                    <?php $sumber = ['Hadiah', 'Pembelian','Tukar Menukar']; ?>
