    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <ul class="timeline">
                    ...
                    <li class="timeline">
                        ...
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="<?= asset('frontend/assets/img/about/6.jpg') ?>" alt="Perpustakaan" />
                        </div>
                        </a>
                    </li>
                </ul>
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">"Budaya malas membaca adalah kekuatan yang melemahkan bangsa dan negeri ini dari segala aspek ekonomi, sosial, dan budaya"</p></div>
                </div>
            </div>
        </section>
        <!-- Clients-->
