  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        ...
        <div class="img-circle" style="width: 35px; height: 35px; background-repeat: no-repeat;background-size: 35px; background-position: center; background-image: url('<?= $_SESSION['foto'] ? upload($_SESSION['foto']) : asset('img/profile.png') ?>') ;"></div>
      </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php if (isJabatan('Kepala')) : ?>
        ...
        <?php $masterMenu = ['peminjaman' => 'fa-exchange', 'pengadaan' => 'fa-forward', 'pengeluaran' => 'fa-backward', 'pengunjung' => 'fa-male', 'buku-populer' => 'fa-pie-chart']; ?>
        <?php foreach ($masterMenu as $link => $icon) : ?>
