...
$route['laporan-pengunjung-terbanyak'] = 'page/pengunjung_terbanyak';
$route['laporan-pengunjung-hari-ini'] = 'page/pengunjung_today';
$route['laporan-pengunjung-cetak'] = 'page/pengunjung_cetak';
$route['laporan-peminjaman'] = 'page/peminjaman';
$route['laporan-buku-populer'] = 'page/buku_populer';
$route['laporan-buku-cetak'] = 'page/buku_cetak';
